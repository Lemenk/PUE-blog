...
public class MarkDown2HtmlWrapper {
    ...
    static {
        try {
            MD_CSS = FileReadUtil.getFileStr("md/huimarkdown.css");
     ...
     * @return
     */
    public static MarkdownEntity ofFile(String path) {
        return ofStream(FileReadUtil.getFileStreamByPath(path));
    }
     ...
     * @return
     */
    public static MarkdownEntity ofUrl(String url) {
        return ofStream(FileReadUtil.getFileStreamByUrl(url));
    }
